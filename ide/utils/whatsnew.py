NEW_THINGS = [
    ...
    ["CloudPebble now has fuzzy file search! Use ctrl-P in the editor to bring up an input prompt, then begin to type the name of a file you would like to open.",
