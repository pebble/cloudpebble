...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bb459c3f-1504-4da6-ae87-d07e29245330'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'43e60bf2-236d-4fdc-b226-9cfbf131ae1c'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
        ...
        'ide.testrun': {
            'Meta': {'ordering': "['original_name', '-date_started']", 'unique_together': "(('test', 'session'),)", 'object_name': 'TestRun'},
