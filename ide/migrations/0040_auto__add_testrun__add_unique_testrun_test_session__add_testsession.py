...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ide_testrun', (
            ...
            ('test', self.gf('django.db.models.fields.related.ForeignKey')(related_name='runs', to=orm['ide.TestFile'])),
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3de06f40-02ef-422d-a1fc-fc20622b1aa2'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'148f2761-36a7-4063-ab36-1148d39cad03'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
        ...
        'ide.testrun': {
            ...
            'test': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'runs'", 'to': "orm['ide.TestFile']"})
        },
        'ide.testsession': {
