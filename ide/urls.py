...
urlpatterns = patterns(
    ...
    url(r'^ping_phone$', views.ping_phone),
    url(r'^check_phone/(?P<request_id>[0-9a-f-]+)$', views.check_phone),
    url(r'^update_phone$', views.update_phone),
    url(r'^list_phones$', views.list_phones),
