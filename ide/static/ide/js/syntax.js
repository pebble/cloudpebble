CloudPebble.Editor.PebbleMode = {
    ...
    keywords: {
        ...
        'GColorClear': true,
        'GColorBlack': true,
        'GColorOxfordBlue': true,
        'GColorDukeBlue': true,
        'GColorBlue': true,
        'GColorDarkGreen': true,
        'GColorMidnightGreen': true,
        'GColorCobaltBlue': true,
        'GColorBlueMoon': true,
        'GColorIslamicGreen': true,
        'GColorJaegerGreen': true,
        'GColorTiffanyBlue': true,
        'GColorVividCerulean': true,
        'GColorGreen': true,
        'GColorMalachite': true,
        'GColorMediumSpringGreen': true,
        'GColorCyan': true,
        'GColorBulgarianRose': true,
        'GColorImperialPurple': true,
        'GColorIndigo': true,
        'GColorElectricUltramarine': true,
        'GColorArmyGreen': true,
        'GColorDarkGray': true,
        'GColorLiberty': true,
        'GColorVeryLightBlue': true,
        'GColorKellyGreen': true,
        'GColorMayGreen': true,
        'GColorCadetBlue': true,
        'GColorPictonBlue': true,
        'GColorBrightGreen': true,
        'GColorScreaminGreen': true,
        'GColorMediumAquamarine': true,
        'GColorElectricBlue': true,
        'GColorDarkCandyAppleRed': true,
        'GColorJazzberryJam': true,
        'GColorPurple': true,
        'GColorVividViolet': true,
        'GColorWindsorTan': true,
        'GColorRoseVale': true,
        'GColorPurpureus': true,
        'GColorLavenderIndigo': true,
        'GColorLimerick': true,
        'GColorBrass': true,
        'GColorLightGray': true,
        'GColorBabyBlueEyes': true,
        'GColorSpringBud': true,
        'GColorInchworm': true,
        'GColorMintGreen': true,
        'GColorCeleste': true,
        'GColorRed': true,
        'GColorFolly': true,
        'GColorFashionMagenta': true,
        'GColorMagenta': true,
        'GColorOrange': true,
        'GColorSunsetOrange': true,
        'GColorBrilliantRose': true,
        'GColorShockingPink': true,
        'GColorChromeYellow': true,
        'GColorRajah': true,
        'GColorMelon': true,
        'GColorRichBrilliantLavender': true,
        'GColorYellow': true,
        'GColorIcterine': true,
        'GColorPastelYellow': true,
        'GColorWhite': true,
        'GCompOp': true,
        'GCompOpAnd': true,
        'GCompOpAssign': true,
