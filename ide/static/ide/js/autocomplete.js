CloudPebble.Editor.Autocomplete = (function() {
    ...
    var functions2 = [
        ...
        ['app_comm_get_sniff_interval', 'SniffInterval', [], true, true],
        ['app_comm_set_sniff_interval', 'void', ['const SniffInterval interval'], true, true],
        ...
        ['light_enable', 'void', ['bool enable'], true, true],
        ['light_enable_interaction', 'void', [], true, true],
        ...
        ['vibes_cancel', 'void', [], true, true],
        ['vibes_double_pulse', 'void', [], true, true],
        ['vibes_enqueue_custom_pattern', 'void', ['VibePattern pattern'], true, true],
        ['vibes_long_pulse', 'void', [], true, true],
        ['vibes_short_pulse', 'void', [], true, true],
