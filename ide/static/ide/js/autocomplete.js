CloudPebble.Editor.Autocomplete = (function() {
    ...
    var functions2 = [
        ...
        ['TRIGANGLE_TO_DEG', 'integer', ['integer']],
        ...
        ['click_recognizer_is_repeating', 'bool', ['ClickRecognizerRef recognizer']],
        ['clock_copy_time_string', 'void', ['char *buffer', 'uint8_t size']],
        ['clock_is_24h_style', 'bool', []],
        ['compass_service_peek', 'int', ['CompassHeadingData *data']],
        ['compass_service_set_heading_filter', 'int', ['CompassHeading filter']],
        ['compass_service_subscribe', 'void', ['CompassHeadingHandler handler']],
        ['compass_service_unsubscribe', 'void', []],
        ...
        ['dict_serialize_tuplets_to_buffer', 'DictionaryResult', ['const Tuplet *const tuplets', 'const uint8_t tuplets_count', 'uint8_t *buffer', 'uint32_t *size_in_out']],
        ['dict_serialize_tuplets_to_buffer_with_iter', 'DictionaryResult', ['DictionaryIterator *iter', 'const Tuplet *const tuplets', 'const uint8_t tuplets_count', 'uint8_t *buffer', 'uint32_t *size_in_out']],
        ['dict_size', 'uint32_t', ['DictionaryIterator *iter']],
        ...
        ['gbitmap_create_blank', 'GBitmap *', ['GSize size']],
        ...
        ['heap_bytes_free', 'size_t', []],
        ['heap_bytes_used', 'size_t', []],
        ...
        ['number_window_get_window', 'Window *', ['NumberWindow *numberwindow']],
        ...
        ['rot_bitmap_layer_increment_angle', 'void', ['RotBitmapLayer *bitmap', 'int32_t angle_change']],
        ['rot_bitmap_layer_set_angle', 'void', ['RotBitmapLayer *bitmap', 'int32_t angle']],
        ['rot_bitmap_layer_set_corner_clip_color', 'void', ['RotBitmapLayer *bitmap', 'GColor color']],
        ['rot_bitmap_set_compositing_mode', 'void', ['RotBitmapLayer *bitmap', 'GCompOp mode']],
        ['rot_bitmap_set_src_ic', 'void', ['RotBitmapLayer *bitmap', 'GPoint ic']],
        ...
        ['simple_menu_layer_get_menu_layer', 'MenuLayer *', ['SimpleMenuLayer *simple_menu']],
        ...
        ['uuid_equal', 'bool', ['const Uuid *uu1', 'const Uuid *uu2']],
        ['uuid_to_string', 'void', ['const Uuid *uuid', 'char *buffer']],
        ['vibes_cancel', 'void', []],
        ...
        ['window_get_click_config_context', 'void *', ['Window *window']],
