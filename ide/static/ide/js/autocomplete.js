CloudPebble.Editor.Autocomplete = (function() {
    ...
    var functions2 = [
        ...
        ['graphics_text_layout_get_max_used_size', 'GSize', ['GContext* ctx', 'const char* text', 'GFont const font', 'const GRect box', 'const GTextOverflowMode overflow_mode', 'const GTextAlignment alignment', 'GTextLayoutCacheRef layout']],
        ['grect_align', 'void', ['GRect *rect', 'const GRect *inside_rect', 'const GAlign alignment', 'const bool clip']],
        ...
        ['persist_read_data', 'int', ['const uint32_t key', 'const size_t buffer_size', 'void *buffer']],
        ['persist_read_int', 'int32_t', ['const uint32_t key']],
        ['persist_read_string', 'int', ['const uint32_t key', 'const size_t buffer_size', 'char *buffer']],
        ['persist_write_bool', 'status_t', ['const uint32_t key', 'const bool value']],
        ['persist_write_data', 'int', ['const uint32_t key', 'const size_t size', 'const void *data']],
