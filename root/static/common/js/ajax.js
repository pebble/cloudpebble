Ajax = {
     ...
     * @param {string} [success_key=success] the name of the key in the JSON result object
     *                  which must have a truthy value for the request to be considered successful.
     * @returns {Promise}
     */
    Wrap: function(deferred, success_key) {
        if (typeof success_key === "undefined") success_key = 'success';
